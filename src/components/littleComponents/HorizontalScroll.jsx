  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
        <h1 className="font-Harmattan font-bold text-[100px] text-center leading-[80%]">
            Get Started
          </h1>
          <h1 className="font-Harmattan font-bold text-[100px] text-center leading-[80%]">
      ...
      >
        <div className="image w-[20rem] h-[20rem] z-30 overflow-hidden -translate-y-1/2  absolute top-1/2 left-0 -translate-x-1/2 rounded-full">
          <img
        ...
        <h1 className="absolute text-black translate-y-[722%] font-Economica font-bold tracking-wide text-[15px] top-1/2 left-0 -translate-x-1/2">
          Hey , I’m Kanha Vishwakarma.....
        </h1>
        <div className="w-[300px] absolute top-[20%] left-[20%]">
          <p className="text-[16px] font-Economica tracking-wide text-black font-bold">
            {" "}
